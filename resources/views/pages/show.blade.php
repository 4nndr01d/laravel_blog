        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="top-comment" style="min-height: 130px;">
                        <img src="{{$post->author->getAvatar()}}" style="width:100px;" class="pull-left img-circle"
                             alt="">
                        <h4>{{$post->author->name}}</h4>
                        <p>{{$post->author->thought}}</p>
                    </div>
                            ...
                            @if($post->hasPrevious())
                                <div class="single-blog-box">
                                    <a href="{{$post->getPrevious()->slug}}">
                                        <img src="{{$post->getPrevious()->getImage()}}" alt="" style="height:240px;">
                                        <div class="overlay">
                            ...
                            @if($post->hasNext())
                                <div class="single-blog-box">
                                    <a href="{{$post->getNext()->slug}}">
                                        <img src="{{$post->getNext()->getImage()}}" alt="" style="height:240px;">
                            ...
                            @foreach($post->related() as $item)
                                <div class="single-item">
                                    <a href="{{route('post.show', $item->slug)}}">
                                        <img src="{{$item->getImage()}}" alt="" style="padding: 5px; height: 150px;">
                                        <p>{{$item->title}}</p>
                                    </a>
                                </div>
                            @endforeach
                        ...
                        @foreach($post->getComments() as $comment)
                            <div class="bottom-comment"><!--bottom comment-->
                                ...
                                <div class="comment-img">
                                    <img class="img-circle" src="{{$comment->author->getAvatar()}}" style="height: 75px; width: 75px;" alt="">
                                </div>
