                ...
                @foreach($featuredPosts as $featured)
                    <div class="item">
                        <div class="feature-content">
                            <img src="{{$featured->getImage()}}" style="height:200px;" alt="">
        ...
        <aside class="widget pos-padding">
            ...
            @foreach($recentPosts as $post)
                <div class="thumb-latest-posts">
                    <div class="media" style=" display: flex; flex-wrap: wrap; flex-direction: column; " >
                        <div class="media-left">
                            <a href="{{route('post.show', $post->slug)}}" class="popular-img">
                                <img src="{{$post->getImage()}}" style="height:195px;" alt="">
                                <div class="p-overlay"></div>
                            </a>
                        </div>
                        <br>
